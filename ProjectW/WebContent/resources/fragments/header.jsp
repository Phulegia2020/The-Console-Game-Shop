...
<body>
	...
	<header>
		...
		<nav class="navbar navbar-expand-lg navbar-light bg-dark">
			...
			<a href="index.html" class="navbar-brand"><span style="color: #E87400">MachineGameShop</span></a>
<!-- 			<a href="index.html" class="navbar-brand">MachineGame<span -->
<!-- 				style="color: #00E8E8;">Shop</span></a>		 -->
			...
			<div class="collapse navbar-collapse navbarMenu">
				<a class="btn shopping-cart text-white" href="shopping-cart.html"><i
					class="fas fa-shopping-cart fa-x text-white"></i><span
					class="cart-number">${sessionScope.myCartNum!=null?sessionScope.myCartNum:0}</span>Giỏ hàng</a>
				<c:if test="${sessionScope.usersession==null}">
					<a class="btn menu-right-btn text-white" href="sign-in.html"><i
						class="fas fa-user fa-x fa-fw"></i>Đăng Nhập</a>
				</c:if>
				<c:if test="${sessionScope.usersession!=null}">
					<a class="btn menu-right-btn text-white" href="account-info.html"><i
						class="fas fa-user fa-x fa-fw"></i>Thông Tin</a>
					<a class="btn menu-right-btn text-white" href="logout.html"><i
						class="fas fa-sign-out-alt fa-x fa-fw"></i>Đăng Xuất</a>
				</c:if>
			</div>
		</nav>
		<!--End top header-->
					...
					<li class="dropdown nav-item"><a href="product.html"
						...
						<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
							<c:forEach var="l" items="${listCategory}">
								<a class="dropdown-item" href="kinds/${l.id}.html" />${l.name}</a>
							</c:forEach>
						</div></li>
