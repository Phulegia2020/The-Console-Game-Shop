							...
							<tbody>
								<c:forEach var="map" items="${sessionScope.myCartItems}">
									<tr>
										...
										<td>
											<a href="${pageContext.request.contextPath}/shopping-cart/remove/${map.value.product.id}.html"
			...
			<div class="row">
				<div class="col-md-6">
					<div class="row mb-5">
						<div class="col-md-6">
							<a href="product.html"
								class="btn btn-outline-primary btn-sm btn-block">Tiếp tục mua sắm</a>
						</div>
					</div>
				</div>
