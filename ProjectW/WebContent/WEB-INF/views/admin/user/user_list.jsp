										...
										<div class="float-right">
											...
											<div class="btn-group">
												...
												<c:forEach var="i" begin="0" end="${page}">
													<a class="btn btn-default" href="admin/user/${i+1}.html">
														<c:out value="${i+1}" />
													</a>
												</c:forEach>
											...
											<c:forEach var="item" items="${listUser}">
												<tr class="unread checked">
													...
													<td style="text-align: center; width: 150px;">
														<a class="btn btn-default" href="admin/user/update/${item.id}.html">
															<i class="fa fa-edit"></i>
														</a>
														<a class="btn btn-default" href="admin/user/remove/${item.id}.html">
