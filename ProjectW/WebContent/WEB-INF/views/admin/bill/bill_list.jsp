										...
										<div class="float-right">
											...
											<div class="btn-group">
												...
												<c:forEach var="i" begin="0" end="${page}">
													<a class="btn btn-default" href="admin/bill/${i+1}.html">
														<c:out value="${i+1}" />
													</a>
												</c:forEach>
											...
											<c:forEach var="item" items="${listBill}">
												<tr class="unread checked">
													...
													<td style="text-align: center; width: 150px;">
														<a class="btn btn-default" href="admin/bill/detail/${item.id}.html"><i class="fa fa-eye"></i></a>
														<a class="btn btn-default" href="admin/bill/updateStatus/${item.id}.html"><i class="fa fa-check"></i></a>
														<a class="btn btn-default" href="admin/bill/remove/${item.id}.html"><i class="fa fa-remove"></i></a>
													</td>
												</tr>
											</c:forEach>
										</tbody>
