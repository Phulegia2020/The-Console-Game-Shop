											...
											<c:forEach var="item" items="${listCategory}">
												<tr class="unread checked">
													...
													<td style="text-align: center; width: 150px;">
														<a class="btn btn-default" href="admin/category/update/${item.id}.html"><i class="fa fa-edit"></i></a>
														<a class="btn btn-default" href="admin/category/remove/${item.id}.html"><i class="fa fa-remove"></i></a>
													</td>
												</tr>
											</c:forEach>
										</tbody>
