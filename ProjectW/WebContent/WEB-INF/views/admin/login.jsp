...
<!--                         	<p><a href="return.html">Quay về cửa hàng</a></p> -->
<!--                         </div> -->
                        <h2><a href="return.html" class="btn btn-danger btn-block" role="button">Quay về cửa hàng</a></h2>
                    </form:form>
                </div>
            </div>
        </div>
        ...
        <div class="copyrights">
        	<p>Design by MachineGameShop</p>
<!--             <p>Design by  <a href="https://teamvietdev.com/" target="_blank">MachineGameShop</a> </p> -->
        </div>	
