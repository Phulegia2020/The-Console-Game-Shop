		...
		<div class="header-left">
			<div class="logo-name">
				<a href="admin/index.html">
					<h2>PS4Shop</h2> <!--<img id="logo" src="" alt="Logo"/>-->
				</a>
			</div>
			<!--search-box-->
			<div class="search-box">
				<form>
					<input type="text" placeholder="Search..." required=""> <input type="submit" value="">
				</form>
			</div>
			<!--//end-search-box-->
					...
					<li class="dropdown profile_details_drop">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
							<div class="profile_img">
								<span class="prfil-img"><img src="resources/admin/images/p7.png" alt=""> </span>
								<div class="user-name">
						...
						<ul class="dropdown-menu drp-mnu">
							<li><a href="admin/index.html"><i class="fa fa-cog"></i> Settings</a></li>
							<li><a href="admin/index.html"><i class="fa fa-user"></i> Profile</a></li>
							<li><a href="admin/logout.html"><i class="fa fa-sign-out"></i>Logout</a></li>
						</ul>
					</li>
				</ul>
			</div>
