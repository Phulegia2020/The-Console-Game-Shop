										...
										<div class="float-right">
											...
											<div class="btn-group">
												...
												<c:forEach var="i" begin="0" end="${page}">
													<a class="btn btn-default" href="admin/product/${i+1}.html">
														<c:out value="${i+1}" />
													</a>
												</c:forEach>
...
<%-- 													<td>${item.productstatus.name}</td> --%>
													<td style="text-align: center; width: 150px;">
														<a class="btn btn-default" href="admin/product/update/${item.id}.html"><i class="fa fa-edit"></i></a>
														<a class="btn btn-default" href="admin/product/remove/${item.id}.html"><i class="fa fa-remove"></i></a>
													</td>
												</tr>
											</c:forEach>
										</tbody>
