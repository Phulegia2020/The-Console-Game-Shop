	...
	<div class="site-section mb-3">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-7">
					<form:form action="contact.html" method="post" modelAttribute="contact">
						<div class="p-3 p-lg-5 border">
						<strong class = "notice">${message}</strong> 
				...
				<div class="col-md-5 ml-auto">
					<div class="p-4 border mb-3">
						...
						<p class="mb-0">Km10, Đường Nguyễn Trãi, Q.Hà Đông</p>
					</div>
					<div class="p-4 border mb-3">
						<span class="d-block text-primary h6 text-uppercase">Đã Nẵng</span>
						<p class="mb-0">75 Nguyễn Khuyến, P. Hoà Minh, Q. Liên Chiểu</p>
					</div>
					<div class="p-4 border mb-3">
						<span class="d-block text-primary h6 text-uppercase">Thành phố Hồ Chí Minh</span>
						<p class="mb-0">97 Man Thiện, P. Hiệp Phú, Quận 9</p>
					</div>
